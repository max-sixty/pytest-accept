...
[![Test Actions Status](https://github.com/max-sixty/pytest-accept/workflows/CI/badge.svg?branch=main)](https://github.com/max-sixty/pytest-accept/actions?query=workflow:test)
